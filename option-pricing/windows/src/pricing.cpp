...
double __stdcall call_price_closed_from(const double &S, const double &K, const double &r, const double &v, const double &T) {
...
double __stdcall call_price_mc(const double &S, const double &K, const double &r, const double &v, const double &T, const int &num_sims) {
